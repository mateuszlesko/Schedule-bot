        ...
        public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (turnContext.Activity.Type == ActivityTypes.Message)
            {
                ...
                switch (turnContext.Activity.Text) {
                    ...
                    case "help":
                        CommandsHelper commands = new CommandsHelper();
                        responseMessage = commands.SeeAllCommands();

                        break;
                    case "today":
                        responseMessage = DateTime.Now.DayOfWeek.ToString();
                      
                        break;
                    case "AllLessons":
                       
                        responseMessage = schedule.getAllSubjects();
                
                        break;
                    case "DailyPlan":
                        
                        responseMessage = schedule.getDailyPlan();
                        break;
                    case "WeeklyPlan":
                        responseMessage = schedule.getWeeklyPlan();
                        break;
                    case "GetWhenStartSchool":
                        responseMessage = schedule.GetWhenStartSchool();
                        break;
